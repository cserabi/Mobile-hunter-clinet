...
const DeliveryStatus = () => {
  ...
  return (
    <div className='container'>
      ...
      <div className="row">
        <h4 className='text-center m-3' style={{ color: '#020f24', fontWeight: 'bold' }}> Check out Delivery Status </h4>

        <div className="col-md-2"></div>
        <div className="col-md-8">
          <Table className="w-100 m-auto " striped bordered hover responsive style={{ color: '#004FF9', border: '2px solid #004FF9', textAlign: 'left' }}>
            <tbody>
              <tr>
                {/* <th>#</th> */}
                <td>Booking Date</td>
      ...
      <div className="row">
        ...
        <div className="col-md-8">
          ...
          <Table striped bordered hover responsive style={{ marginTop: '20px' }}>
            ...
            <tbody>
              <tr>
                <td> <a className="btn btn-warning btn-design" href="#Mydiv" data-toggle="collapse"> + </a></td>
